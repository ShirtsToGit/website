	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="footer-area clear">
			...
			<div class="site-info">
				...
				<p><small>Heart by Diego Naive from the Noun Project | Tshirt and hoodie by Zlatko Najdenovski from the Noun Project | sticker by Andrejs Kirma from the Noun Project</small></p>
			</div><!-- .site-info -->
		</div><!-- .footer-area -->
	</footer><!-- #colophon -->
</div><!-- #page -->
